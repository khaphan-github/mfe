...
export interface Select2Option {
  ...
  // Object data to search with static data
  searchData?: string[];
}

export type Select2Value = string | number | boolean | object;

export type Select2UpdateValue = Select2Value | Select2Value[] | null;

export type Select2Data = (Select2Group | Select2Option)[] | any;
...
export interface Select2UpdateEvent<U extends Select2UpdateValue = Select2Value> {
  ...
  readonly value: U;
  /** selected option */
  readonly options: Select2Option[] | any;
}
