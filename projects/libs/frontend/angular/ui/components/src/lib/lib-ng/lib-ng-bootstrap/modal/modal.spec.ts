  ...
  beforeEach(() => {
    jasmine.addMatchers({
      toHaveModal: function () {
        return {
          compare: function (actual: { outerHTML: any; }, content?: string | any[], selector?: any) {
          ...
          negativeCompare: function (actual: { querySelectorAll: (arg0: string) => any; outerHTML: any; }) {
    ...
    jasmine.addMatchers({
      toHaveBackdrop: function () {
        return {
          compare: function (actual: { outerHTML: any; }) {
            return {
          ...
          negativeCompare: function (actual: { outerHTML: any; }) {
...
class TestComponent {
  ...
  @ViewChild('contentWithImplicitContext', { static: true }) tplContentWithImplicitContext: any;
