...
var initApp = (function (app) {
  ...
  app.listFilter = function (list, input, anchor) {
    console.log('list-filter = ', { list, input, anchor });
        ...
        switch (true) {
          ...
          case (actiontype === 'toggle-swap'):
            ...
            if (dataClass.startsWith("root-text")) {
              ...
              console.log('dataClass.startsWith(');
            }
          ...
          case (actiontype === 'lang'):
            ...
            if (!$.i18n) {
              ...
              i18n.setLng(applang, function () {
                ...
                console.log('i18n.setLng(applang, function ()');
              });
...
//TODO: CHIA THÀNH 2: KÍCH HOẠT, XỬ LÝ
//TODO: XỬ LÝ LẠI MEM LAYOUT

// function activeJQuery(__my_app_config) {
//   this.myapp_config = __my_app_config;

//   console.log('%c✔ START JQUERY', "color: #148f32");
//   initApp.addDeviceType();
//   initApp.detectBrowserType();
//   initApp.mobileCheckActivation();
